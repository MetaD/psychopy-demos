...
expName = 'stroopReverse'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Download\\psychopy-stroop-stroopExtended\\stroopReverse_lastrun.py',
...
practice = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('trialTypesReverse.xlsx'),
